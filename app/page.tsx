...
const services = [
  ...
  { id: "acara", title: "Acara Besar", icon: "calendar", desc: "Reservasi acara minimal H-1 sebelum kedatangan." },
...
export default function HomePage() {
  ...
  return <div className="min-h-screen bg-[#f7f9fb] pb-20 font-sans text-[#001e3c]">
    ...
    </main><nav className="fixed bottom-0 left-0 right-0 border-t border-slate-200 bg-white px-5 py-3 shadow-[0_-2px_10px_rgba(0,30,60,.05)]"><div className="mx-auto flex max-w-6xl justify-around text-xs font-bold"><span className="text-[#002b5b]">Layanan</span><button onClick={() => router.push("/riwayat")} className="text-slate-500">Riwayat Pesanan</button><a href="https://wa.me/6281246178877" className="text-[#1db954]">WhatsApp</a></div></nav>
  </div>;
}
